    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "github_link",
                    models.URLField(help_text="Link to github repo", max_length=150),
                ),
                (
                    "description",
                    models.TextField(help_text="Project Description", max_length=500),
                ),
                ("created_at", models.DateTimeField(auto_now=True)),
                (
                    "team",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="timathon.team"
                    ),
                ),
            ],
        ),
